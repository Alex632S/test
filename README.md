...
Получить данные из файла [data.json](./data.json) и вывести их на страницу как это показано на рисунке с левой стороны.
...
Сопоставления id групп и товаров с их названиями находятся в файле [names.json](./names.json).
